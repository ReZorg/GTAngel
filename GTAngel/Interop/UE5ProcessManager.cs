...
// ── Supporting types ─────────────────────────────────────────────────────────
// AvatarAction, AvatarObservation, NeurochemicalSnapshot, and PerceivedObject
// have been split into per-type files alongside this one
// (see GTAngel/Interop/AvatarAction.cs etc.) so the IPC contract is
// independently navigable from the process manager.
